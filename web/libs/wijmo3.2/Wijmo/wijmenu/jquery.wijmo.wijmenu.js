    ...
    (function (menu) {
        ...
        var wijmenu = (function (_super) {
            ...
            wijmenu.prototype._createMenuItems = function () {
                var self = this, items = [], o = self.options, optionItemsLength = self.options.items.length, childMenuCount = self._getSublist().children('li').length, i, w, submenuContainer, itemContainer;
                for(i = 0; i < optionItemsLength - childMenuCount; i++) {
                    self._getSublist().append('<li>');
                }
                if(o.ensureSubmenuOnBody && o.mode === "flyout") {
                    submenuContainer = $("<div>").addClass(o.wijCSS.helperReset).addClass(o.wijCSS.widget).addClass(o.wijCSS.header).addClass(o.wijCSS.wijmenu).addClass(o.wijCSS.wijmenuSubmenuContainer);
                    if(o.orientation === "horizontal" && o.mode === "flyout") {
                        submenuContainer.addClass(o.wijCSS.wijmenuHorizontal);
                    }
                ...
                $(">li", self._getSublist()).each(function (i, n) {
                    ...
                    if(o.ensureSubmenuOnBody && o.mode === "flyout") {
                        $(submenuContainer).append(itemContainer).appendTo("body");
                    }
                    return this;
                });
                return items;
        ...
        var wijmenuitem = (function (_super) {
            ...
            wijmenuitem.prototype._setMenuItemPosition = function () {
                ...
                //self.element.children('iframe.bgiframe').position($.extend(obj, pOption));
                            };
            ...
            function (sublist, frame) {
                var self = this, sublistShadowBox, leftOffset, rightOffset, topOffset, bottomeOffset, shadowRadius, shadowBlurRadius, yOffset, xOffSet, arrayLength, browser = $.browser;
